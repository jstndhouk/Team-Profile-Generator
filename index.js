...
<div class="card-body">
  ...
  <p class="card-text">${name}</p></br>
  <p class="card-text">${id}</p>
  <a href="mailto:${email}"class="card-text">${email}</a>
  <a href="https://github.com/${github}" text='' class="card-text">${github}</a>
</div>
</div>` }).join('')
return engineers
}
...
fs.writeFile('index.html', generateCards(team), err => err ? console.error(err) : console.log('Success!'))
}